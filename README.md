...
and you should find that this teamsrequest has been added to the list of
installed modules.
...
[![Build Status](https://travis-ci.org/danielneis/moodle-block_teamsrequest.svg?branch=master)](https://travis-ci.org/danielneis/moodle-block_teamsrequest)
